...
class Option(NetOption):
    def __init__(self, conf_path):
        ...
        self.A_split = self.conf['A_split']
        self.A_n_fold = self.conf['A_n_fold']
        self.latent_dim_rec = self.conf['latent_dim_rec']
        self.lightGCN_n_layers = self.conf['lightGCN_n_layers']
